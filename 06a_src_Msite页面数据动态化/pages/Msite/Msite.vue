              ...
              <div class="shop_right">
                ...
                <section class="shop_rating_order">
                  <section class="shop_rating_order_left">
                    <ele-stars class="stars" :mr='2' size="24" :score="shop.rating">
...
<script>
  import {GETADDRESS,GETCATEGORIES,GETSHOPS} from "store/mutation_types"
  ...
  export default {
    ...
    computed:{
      ...
      categoryArrs(){
        // 这是lodash库的一个数组方法,把一个大数组按多少个数分成几个小数组 ,这是把16个项按8个分成两个数组
        return _.chunk(this.categories,8) 
      }
    },
    methods:{
      ...mapActions([GETADDRESS,GETCATEGORIES,GETSHOPS]),
      renderSwiper(){
        this.$nextTick(() => {
